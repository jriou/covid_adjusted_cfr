...
bashfile_rdump("model16",id="BA-A",data_list_model16A,warmup=500,iter=500,adapt_delta=0.8,max_depth=10,init=0.5,timelimit=12,chains=4)

# system("scp /home/julien/Dropbox/Unibe/covid-19/covid_adjusted_cfr/models/model16.stan /home/julien/Dropbox/Unibe/covid-19/covid_adjusted_cfr/run_models/sb_model16BA* /home/julien/Dropbox/Unibe/covid-19/covid_adjusted_cfr/run_models/data_S_model16BA* UBELIX:projects/COVID_age/model/.")

# Copy back posterior samples
system("scp  UBELIX:projects/COVID_age/model/S_model16BA-A_2020-05-04-16-25-31_*  /home/julien/Dropbox/Unibe/covid-19/covid_adjusted_cfr/posterior_samples/.")
system("scp  UBELIX:projects/COVID_age/model/data_S_model16BA-A_2020-05-04-16-25-31.R /home/julien/Dropbox/Unibe/covid-19/covid_adjusted_cfr/posterior_samples/.")

# BAad posterior samples 
D_S_model16ABA = read_rdump("posterior_samples/data_S_model16BA-A_2020-05-04-16-25-31.R")
S_model16ABA = read_stan_csv(paste0("posterior_samples/",dir("posterior_samples",pattern = 'S_model16BA-A_2020-05-04-16-25-31_[[:digit:]]+.csv')))

# Checks
check_hmc_diagnostics(S_model16ABA)
print(S_model16ABA,pars=c("beta","eta","epsilon","rho","pi","psi"),digits_summary=4)
print(S_model16ABA,pars=c("cfr_A_symptomatic","cfr_B_symptomatic","cfr_C_symptomatic","cfr_D_symptomatic","cfr_C_all","cfr_D_all"),digits_summary=5)


# PBAts
source('format_output/functions_model16.R')
plot_incidence_cases(S_model16ABA,D_S_model16ABA,start_date = day_start,end_date = day_max)
...
# Save
save(S_model16ABA,D_S_model16ABA,file="posterior_samples/posterior_samples_BA_2020-05-04.Rdata")
