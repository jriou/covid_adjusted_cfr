...
bashfile_rdump("model13d",id="IT-A",data_list_model13,warmup=500,iter=500,adapt_delta=0.8,max_depth=10,init=0.5,timelimit=2,chains=4)
...
bashfile_rdump("model13d",id="IT-B",data_list_model13,warmup=500,iter=500,adapt_delta=0.8,max_depth=10,init=0.5,timelimit=2,chains=4)
