...
bashfile_rdump("model16",id="LO-A",data_list_model16A,warmup=500,iter=500,adapt_delta=0.8,max_depth=10,init=0.5,timelimit=12,chains=4)

# system("scp /home/julien/Dropbox/Unibe/covid-19/covid_adjusted_cfr/models/model16.stan /home/julien/Dropbox/Unibe/covid-19/covid_adjusted_cfr/run_models/sb_model16LO* /home/julien/Dropbox/Unibe/covid-19/covid_adjusted_cfr/run_models/data_S_model16LO* UBELIX:projects/COVID_age/model/.")

# Copy back posterior samples
system("scp  UBELIX:projects/COVID_age/model/S_model16LO-A_2020-05-05-12-13-15_*  /home/julien/Dropbox/Unibe/covid-19/covid_adjusted_cfr/posterior_samples/.")
system("scp  UBELIX:projects/COVID_age/model/data_S_model16LO-A_2020-05-05-12-13-15.R /home/julien/Dropbox/Unibe/covid-19/covid_adjusted_cfr/posterior_samples/.")

# Load posterior samples 
D_S_model16ALO = read_rdump("posterior_samples/data_S_model16LO-A_2020-05-05-12-13-15.R")
S_model16ALO = read_stan_csv(paste0("posterior_samples/",dir("posterior_samples",pattern = 'S_model16LO-A_2020-05-05-12-13-15_[[:digit:]]+.csv')))


# Checks
check_hmc_diagnostics(S_model16ALO)
print(S_model16ALO,pars=c("beta","eta","epsilon","rho","pi","psi","mu","nu","xi"),digits_summary=4)
print(S_model16ALO,pars=c("cfr_A_symptomatic","cfr_B_symptomatic","cfr_C_symptomatic","cfr_D_symptomatic","cfr_C_all","cfr_D_all"),digits_summary=5)


# Plots
source('format_output/functions_model16.R')
plot_incidence_cases(S_model16ALO,D_S_model16ALO,start_date = day_start,end_date = day_max)
...
# Save
save(S_model16ALO,D_S_model16ALO,file="posterior_samples/posterior_samples_LO_2020-05-05.Rdata")
