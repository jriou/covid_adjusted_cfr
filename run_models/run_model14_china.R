...
# test
M_model14 = stan_model("models/model14.stan")
T_model14 = sampling(M_model14,
                     data = data_list_model14,
                     iter = 5,
                     chains = 1,
                     init=0,
                     control=list(max_treedepth=10,adapt_delta=0.8))
print(T_model14,pars=c("beta","eta","epsilon","rho_K","pi"))
...
# symptomatic = 80% (A) (Bi et al) / Comorbidity = diabetes (1) / 
data_list_model14$p_psi=c(71,18) 
data_list_model14$com_dist = dist_diabetes_pop
data_list_model14$comdistr_cases = diabetes_tmax[[1]]
data_list_model14$comdistr_deaths = diabetes_tmax[[2]]
bashfile_rdump("model14",id="A1",data_list_model14,warmup=500,iter=500,adapt_delta=0.8,max_depth=10,init=0.5,timelimit=96,chains=4)

# symptomatic = 50% (B) (Diamond princess https://www.mhlw.go.jp/stf/newpage_10094.html) / Comorbidity = diabetes (1) / 
data_list_model14$p_psi=c(369,329) 
data_list_model14$com_dist = dist_diabetes_pop
data_list_model14$comdistr_cases = diabetes_tmax[[1]]
data_list_model14$comdistr_deaths = diabetes_tmax[[2]]
bashfile_rdump("model14",id="B1",data_list_model14,warmup=500,iter=500,adapt_delta=0.8,max_depth=10,init=0.5,timelimit=96,chains=4)



# Copy on cluster
system("scp /home/julien/Dropbox/Unibe/covid-19/covid_adjusted_cfr/models/model14.stan /home/julien/Dropbox/Unibe/covid-19/covid_adjusted_cfr/run_models/sb_model14*.sh /home/julien/Dropbox/Unibe/covid-19/covid_adjusted_cfr/run_models/data_SIM_model14* /home/julien/Dropbox/Unibe/covid-19/covid_adjusted_cfr/run_models/data_S_model14* UBELIX:projects/COVID_age/model/.")

# Copy back posterior samples
system("scp  UBELIX:projects/covid_adjusted_cfr/model/S_model14_2020-03-02* /home/julien/Dropbox/Unibe/covid-19/covid_adjusted_cfr/model/.")
system("scp  UBELIX:projects/covid_adjusted_cfr/model/SIM_model14_2020-03-02* /home/julien/Dropbox/Unibe/covid-19/covid_adjusted_cfr/model/.")

# Load posterior samples 
S_model14 = read_stan_csv(dir(".",pattern = 'SIM_model14_2020-03-02-18-45-16_[[:digit:]]+.csv'))
S_model14 = read_stan_csv(dir(".",pattern = 'S_model14_2020-03-02-18-45-16_[[:digit:]]+.csv'))

# Checks
check_hmc_diagnostics(S_model14)
check_hmc_diagnostics(SIM_model14)

print(S_model14,pars=c("beta","eta","epsilon","rho_K","pi"),digits_summary=4)

plot_incidence_cases(SIM_model14,D_SIM_model14)
plot_incidence_deaths(SIM_model14,D_SIM_model14)
