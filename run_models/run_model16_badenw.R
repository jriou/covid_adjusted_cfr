...
bashfile_rdump("model16",id="BW-A",data_list_model16A,warmup=500,iter=500,adapt_delta=0.8,max_depth=10,init=0.5,timelimit=12,chains=4)

# system("scp /home/julien/Dropbox/Unibe/covid-19/covid_adjusted_cfr/models/model16.stan /home/julien/Dropbox/Unibe/covid-19/covid_adjusted_cfr/run_models/sb_model16BW* /home/julien/Dropbox/Unibe/covid-19/covid_adjusted_cfr/run_models/data_S_model16BW* UBELIX:projects/COVID_age/model/.")

# Copy back posterior samples
system("scp  UBELIX:projects/COVID_age/model/S_model16BW-A_2020-05-04-16-21-01_*  /home/julien/Dropbox/Unibe/covid-19/covid_adjusted_cfr/posterior_samples/.")
system("scp  UBELIX:projects/COVID_age/model/data_S_model16BW-A_2020-05-04-16-21-01.R /home/julien/Dropbox/Unibe/covid-19/covid_adjusted_cfr/posterior_samples/.")

# BWad posterior samples 
D_S_model16ABW = read_rdump("posterior_samples/data_S_model16BW-A_2020-05-04-16-21-01.R")
S_model16ABW = read_stan_csv(paste0("posterior_samples/",dir("posterior_samples",pattern = 'S_model16BW-A_2020-05-04-16-21-01_[[:digit:]]+.csv')))

# Checks
check_hmc_diagnostics(S_model16ABW)
print(S_model16ABW,pars=c("beta","eta","epsilon","rho","pi","psi"),digits_summary=4)
print(S_model16ABW,pars=c("cfr_A_symptomatic","cfr_B_symptomatic","cfr_C_symptomatic","cfr_D_symptomatic","cfr_C_all","cfr_D_all"),digits_summary=5)


# PBWts
source('format_output/functions_model16.R')
plot_incidence_cases(S_model16ABW,D_S_model16ABW,start_date = day_start,end_date = day_max)
...
# Save
save(S_model16ABW,D_S_model16ABW,file="posterior_samples/posterior_samples_BW_2020-05-04.Rdata")
